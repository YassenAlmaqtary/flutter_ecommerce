...
import 'package:mystore/components/show_dialog.dart';
...
import 'package:mystore/controller/card/card_controller.dart';
          ...
          child: GestureDetector(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GetBuilder<CardController>(
                          init:CardController(product:widget.product,quintity:1),
                          builder:(controller)=> InkWell(
                            onTap:(){
                              controller.addToCard();
                              if(controller.load.value==false)
                                ShowDialog(context:context,title:'يتم اضافة البيانات');
                ...
                Text(
                  widget.product.descount==null?"${widget.product.price}\$":"${widget.product.descount}\$",
                  style: TextStyle(
                      fontSize: getProportionateScreenWidth(
                          context: context, inputWidth: 18),
                      fontWeight: FontWeight.w600,
